...
class SendMailingTest(AsychronousLucteriosTest):
    ...
    def test(self):
        ...
        self.assert_grid_equal('emailsent', {"contact": "contact", "email": "courriel", "date": "date", "success": "succès",
        ...
        self.assert_json_equal('', "statistic", "9 message(s) envoyé(s) (dont 1 en erreur).{[br/]}Avec 3 message(s) ouvert(s) cela donne un taux de 33.3 % d'ouverture.")
