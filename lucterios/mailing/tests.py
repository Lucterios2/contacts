...
class SendMailingTest(AsychronousLucteriosTest):
    ...
    def test(self):
        ...
        self.assert_grid_equal('emailsent', {"contact": "contact", "email": "courriel", "date": "date", "success": "succès"}, 7)
        ...
        self.assert_json_equal('', "emailsent/@6/email", "émilie@worldcompany.com")
        self.assert_json_equal('', "emailsent/@6/success", 0)
